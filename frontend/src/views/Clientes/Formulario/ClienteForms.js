...
class ClienteForms extends Component {
  ...
  {/*--Basic form---*/}
      ...
      <FormGroup row>
         ...
         <Col xs="12" md="9">
               <p className="form-control-static">@clienteName</p>
         </Col>
       </FormGroup>
       ...
       <FormGroup row className="my-0">
         ...
         <Input type="text" id="postal-code" placeholder="código postal"/>
           ...
           <FormGroup row>
          <Col md="3"><Label htmlFor="text-input">País</Label></Col>
          <Col xs="12" md="9">
          <Input type="text" id="text-input" name="text-input" placeholder="Text" />
          <FormText color="muted">Escribe país </FormText>
          </Col>
       </FormGroup>
                  ...
                  <FormGroup row hidden>
                    <Col md="3">
                      <Label className="custom-file" htmlFor="custom-file-input">personalizar file input</Label>
                    </Col>
                    <Col xs="12" md="9">
