...
class ClienteRow extends React.Component {
    ...
    render() {
      ...
      <tr>
        ...
        <td><Button onClick= {this.seleccionarCliente} outline color="primary"> seleccionar</Button></td>
        <td><Button onClick={()=> this.deleteHandler(this.props.cliente.id)} outline color="danger">Borrar</Button></td>
        </tr>
